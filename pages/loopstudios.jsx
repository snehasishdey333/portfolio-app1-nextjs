...
import bgImg from '../public/assets/projects/project1.png'
    ...
    <div className='w-full overflow-hidden'>
      <div className='w-screen h-[30vh] lg:h-[40vh] relative'>
        ...
        <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-8'>
          <h2 className='py-2'>Loopstudios</h2>
      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8'>
         <div className='col-span-4 p-4 md:p-0'>
            ...
            <button className='px-8 py-2 mt-4 mr-8' >
              <Link href="https://snehasishdey333.github.io/tailwind-with-js-vr-website/">Demo</Link>
            </button>
            <button className='px-8 py-2 mt-4 mr-8'>
              <Link href="https://github.com/snehasishdey333/tailwind-with-js-vr-website">Code</Link>
            </button>

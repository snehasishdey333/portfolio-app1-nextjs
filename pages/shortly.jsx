...
import bgImg from '../public/assets/projects/project2.png'
      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8'>
         <div className='col-span-4 p-4 md:p-0'>
            ...
            <button className='px-8 py-2 mt-4 mr-8' >
                <Link className='https://snehasishdey333.github.io/shortly-tailwindcss/'>Demo</Link>
            </button>
            <button className='px-8 py-2 mt-4 mr-8'>
                <Link href="https://github.com/snehasishdey333/shortly-tailwindcss">Code</Link>
            </button>
